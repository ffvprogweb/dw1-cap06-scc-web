...
class REQ01CadastrarClienteTests {
	...
	@Test
	void ct04_quando_cliente_nao_esta_cadastrado_cadastra_com_sucesso() {
		// Dado
	...
	@Test
	void ct05_quando_cliente_ja_cadastrado_retorna_erro() {
	...
	@Test
	void ct06_quando_cpf_invalido_retorna_erro() {
